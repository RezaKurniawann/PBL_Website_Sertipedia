    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow-lg border-0 rounded-lg">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ url('inputdata/sertifikasi/'.$user->id_user.'/upload') }}" enctype="multipart/form-data">
                        @csrf
                        
                        
                        <div class="form-group mb-3">
                            <label for="nama" class="col-form-label" style="font-weight: bold;">{{ __('Nama Sertifikasi') }}</label>
                        ...
                        <div class="form-group mb-3">
                            <label for="no_sertifikasi" class="col-form-label" style="font-weight: bold;">{{ __('Nomor Sertifikasi') }}</label>
                            <input id="no_sertifikasi" type="text" class="form-control custom-input @error('no_sertifikasi') is-invalid @enderror" name="no_sertifikasi" required style="border-radius: 5px; transition: all 0.3s ease-in-out;" placeholder="Masukkan Nomor Sertifikasi">
                        ...
                        <div class="form-group mb-3">
                            <label for="jenis_sertifikasi" class="col-form-label" style="font-weight: bold;">{{ __('Jenis Sertifikasi') }}</label>
                            <select id="jenis_sertifikasi" class="form-control custom-input @error('jenis_sertifikasi') is-invalid @enderror" name="jenis_sertifikasi" required style="border-radius: 5px; transition: all 0.3s ease-in-out;">
