        ...
        <div class="col-md-8">
            <div class="card shadow-lg border-0 rounded-lg">
                ...
                <div class="card-body bg-light">
                        ...
                        @endif
                        <form method="POST" action="{{ url('inputdata/pelatihan/' . $user->id_user . '/upload') }}"
                            enctype="multipart/form-data">
                        @csrf
                        <div class="form-group mb-3">
                                <label for="nama" class="col-form-label"
                                    style="font-weight: bold;">{{ __('Nama Pelatihan') }}</label>
                        ...
                        <div class="form-group mb-3">
                                <label for="level_pelatihan" class="col-form-label"
                                    style="font-weight: bold;">{{ __('Level') }}</label>
                                <select id="level_pelatihan"
                                    class="form-control custom-input @error('level_pelatihan') is-invalid @enderror"
                                    name="level_pelatihan" required
