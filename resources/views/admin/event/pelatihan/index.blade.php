    ...
    <div class="card card-outline card-primary shadow-sm">
        <div class="card-header ">
            ...
            <div class="card-tools">
                ...
                <a href="{{ url('manage/event/pelatihan/export_pdf') }}" class="btn btn-sm btn-danger mt-1 ">
                    <i class="fa fa-file-pdf"></i> Export PDF
                </a>
                <button onclick="modalAction('{{ url('manage/event/pelatihan/create_ajax') }}')"
    ...
    <script>
        ...
        $(document).ready(function() {
            var dataPelatihan = $('#table_pelatihan').DataTable({
                serverSide: true,
                ajax: {
                    "url": "{{ url('manage/event/pelatihan/list') }}",
                    "dataType": "json",
                    "type": "POST"
                },
                columns: [{
