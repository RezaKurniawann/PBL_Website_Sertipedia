    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                ...
                <a href="{{ url('manage/golongan/export_excel') }}" class="btn btn-sm btn-success mt-1 ">
        ...
        <div class="card-body">
            ...
            @endif
            <table class="table table-bordered table-striped table-hover table-sm" id="table_golongan">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nama</th>
