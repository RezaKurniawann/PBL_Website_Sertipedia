    ...
    <div class="card card-outline card-primary">
        <div class="card-header">
            ...
            <div class="card-tools">
                <button onclick="modalAction('{{ url('manage/pangkat/import') }}')"
                    class="btn btn-sm btn-info mt-1 ">
                    <i class="fa fa-upload"></i> Import pangkat
                </button>
                <a href="{{ url('manage/pangkat/export_excel') }}" class="btn btn-sm btn-success mt-1 ">
