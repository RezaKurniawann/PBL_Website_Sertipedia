<div class="sidebar">
    <style>
        .form-control-sidebar {
            ...
            border: none;
            /* Menghapus border (opsional) */
        }

        .btn-sidebar i {
            color: #ffffff !important;
            /* Ikon pencarian menjadi putih */
        }
        ...
        .nav-link.active {
            ...
            /* Optional: To highlight the active menu */
        }
        ...
        .btn-sidebar i {
            color: #000 !important;
            /* Set button icon color to black */
        }

        .dropdown-menu {
            background-color: rgb(66, 66, 66);
            /* Warna latar dropdown (abu-abu gelap) */
        }
        ...
        .dropdown-menu .dropdown-item:hover {
            ...
            /* Warna biru kontras untuk hover */
            color: #fff;
    ...
    <div class="form-inline mt-2">
        <div class="input-group" data-widget="sidebar-search">
            <input class="form-control form-control-sidebar" id="sidebarSearch" type="search" placeholder="Search"
    ...
    <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false"
            ...
            @guest
                <li class="nav-item">
                    <a href="{{ url('/guest/homepage') }}" class="nav-link {{ $activeMenu == 'home' ? 'active' : '' }}">
            ...
            @else
                @if (Auth::user()->level->nama == 'Admin')
                    ...
                    <a href="#" class="nav-link dropdown-toggle {{ $activeMenu == 'manage-user' ? 'active' : '' }}"
                    ...
                    <li class="nav-item dropdown">
                        <a href="#"
                            class="nav-link dropdown-toggle {{ $activeMenu == 'manage-event' ? 'active' : '' }}"
                            data-toggle="dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/manage/vendor') }}"
                            class="nav-link {{ $activeMenu == 'manage-vendor' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#"
                            class="nav-link dropdown-toggle {{ $activeMenu == 'manage-jurusan' ? 'active' : '' }}"
                            data-toggle="dropdown">
                            <i class="nav-icon fas fa-school"></i>
                            <!-- Changed to 'fa-school' for education-related icon -->
                            <p>Data Jurusan</p>
                        </a>
                        <div class="dropdown-menu">
                            <a href="{{ url('/manage/jurusan/matakuliah') }}" class="dropdown-item">
                                <i class="fas fa-book"></i> Mata Kuliah
                                <!-- Changed to 'fa-book' for subject-related icon -->
                            </a>
                            <a href="{{ url('/manage/jurusan/bidangminat') }}" class="dropdown-item">
                                <i class="fas fa-cogs"></i> Bidang Minat
                                <!-- Changed to 'fa-cogs' for fields of interest -->
                            </a>
                    ...
                    <li class="nav-item">
                        <a href="{{ url('/manage/periode') }}"
                            class="nav-link {{ $activeMenu == 'manage-periode' ? 'active' : '' }}">
                    ...
                    <li class="nav-item dropdown">
                        <a href="#"
                            class="nav-link dropdown-toggle {{ $activeMenu == 'rekomendasi' ? 'active' : '' }}"
                            data-toggle="dropdown">
                ...
                @elseif (Auth::user()->level->nama == 'Pimpinan')
                    ...
                    <li class="nav-item dropdown">
                        <a href="#"
                            class="nav-link dropdown-toggle {{ $activeMenu == 'verifikasi' ? 'active' : '' }}"
                            data-toggle="dropdown">
                    ...
                    <li class="nav-item">
                        <a href="{{ url('pimpinan/kompetensi') }}"
                    ...
                    <li class="nav-item dropdown">
                        <a href="#"
                            class="nav-link dropdown-toggle {{ $activeMenu == 'inputdata' ? 'active' : '' }}"
                            data-toggle="dropdown">
